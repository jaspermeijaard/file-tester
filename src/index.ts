...
import { validateGpxOrTcxFile } from "./gpxOrTcx";
import { FileValidator, FileType } from "./types";

const validators: FileValidator[] = [validateGpxOrTcxFile, validateFitFile];
...
const application = async () => {
    ...
    return [
        await format("./data/COURSE_24609884"),
        ...
        await format("./data/polar_to_fixed_error_53323911.fit"),
        await format("./data/264191_ridewithgps_ridewithgps_file"),
